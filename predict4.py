...
class Predict:
    ...
    def predict_many(self, df, X, DataScaler, prediction_column, epochs):
    ...
    def go(self):
        ...
        while mean_accuracy < 70:
            ...
            Next5DaysPrice, accuracy = self.predict_many(df, X, DataScaler, prediction_column, 10)
        ...
        plt.title(str(sys.argv[2]) + ' - ' + str(sys.argv[1]))
